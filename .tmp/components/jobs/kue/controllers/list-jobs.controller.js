...
(function () {
  ...
  angular.module('kueJobs').controller('ListJobsController', ListJobsController);
  ...
  function ListJobsController($scope, $q, $interval, $compile, $uibModal, DTOptionsBuilder, DTColumnBuilder, JobsManager, Job) {
    ...
    function activate() {
      ...
      vm.dtOptions = DTOptionsBuilder.newOptions().withOption('ajax', function (data, callback) {
        // if (data.order) {
      ...
      }).withDataProp('data').withOption('language', {}).withOption('responsive', true).withOption('pageLength', perPage).withOption('processing', true).withOption('serverSide', true).withOption('createdRow', function (row) {
      ...
      }).withOption('rowCallback', rowCallback).withPaginationType('full_numbers').withDOM('lrtip'); // remove searching
      ...
      }), DTColumnBuilder.newColumn('customState').withTitle('State').notSortable().renderWith(function (data, type, full) {
        /* jshint camelcase: false */
        var stateLabelClass = full.state_label_class;
        return '<label class="label ' + stateLabelClass + '">' + data + '</label>';
      }), DTColumnBuilder.newColumn('type').withTitle('Type').notSortable(), DTColumnBuilder.newColumn('started').withTitle('Started').notSortable(), DTColumnBuilder.newColumn('finished').withTitle('Finished').notSortable(), DTColumnBuilder.newColumn('humanizeDuration').withTitle('Duration').notSortable(), DTColumnBuilder.newColumn('attempts').withTitle('Attempts').renderWith(function (data) {
...
//# sourceMappingURL=list-jobs.controller.js.map
